...
export const Login = async (req, res) => {
    try {
        ...
        // Signs the JWT token with the user's ID, using the secret "amanstringjibrish" and sets it to expire in 1 h
        const token = await jwt.sign(tokenData, "amanstringjibrish", { expiresIn: "1h" })
